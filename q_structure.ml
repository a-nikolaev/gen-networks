...
let q_structure opt_ecc_file sc = 
  ...
  Printf.printf "# q+1   facet_num   added_facet_num   num-cc   avg-cc-size   max-cc-size \n"; 

  (* number of added facets of size >= link *)
  ...
  for link = max_link downto 1 do
    ...
    Printf.printf "%-8i %-8i %-8i     %-12g %-12g %-12g     %-12g %-12g %-12g\n%!" 
      link
      facets
      (!added_facet_num)
